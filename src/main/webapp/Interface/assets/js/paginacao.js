...
$(document).ready(function () {
    ...
    var rowsShown = 5;
    var rowsTotal = $('.content .media.all').length;
    ...
    $('.content .media.all').hide();
    $('.content .media.all').slice(0, rowsShown).show();
    ...
    $('#pg-link li.number').bind('click', function () {
        ...
        $('.content .media.all').css('opacity', '0.0').hide().slice(startItem, endItem).
